...
class CameraWindow:
    def __init__(self, video_source=0):
        ...
        self.window.title("Tkinter with Video Streaming and Capture")
        ...
        self.vcap = cv2.VideoCapture(video_source, cv2.CAP_AVFOUNDATION)
        ...
        self.delay = 1 #[mili seconds]
        self.update()

    def create_widgets(self):
        #Frame_Camera
        self.frame_cam = tk.LabelFrame(self.window,labelanchor = "n", text = 'Camera', font=self.font_frame)
        self.frame_cam.grid(row=0)
        ...
        # Frame_Button
        self.frame_btn = tk.LabelFrame( self.window,labelanchor = "n", text='Control', font=self.font_frame )
        self.frame_btn.grid(row=1)
