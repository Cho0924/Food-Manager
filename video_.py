...
class CameraWindow(tk.Frame):
    ...
    def create_widgets(self):
        #Frame_Camera
        self.frame_cam = tk.LabelFrame(self.master,labelanchor = "n", text = 'Camera', font=self.font_frame)
        ...
        # Frame_Button
        self.frame_btn = tk.LabelFrame( self.master,labelanchor = "n", text='Control', font=self.font_frame )
...
def main():
    root = tk.Tk()
    CameraWindow(master=root)#Inherit
    root.mainloop()
